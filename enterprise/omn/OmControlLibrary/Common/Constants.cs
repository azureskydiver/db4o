...
namespace OMControlLibrary.Common
{
	...
	public class Constants
	{
		...
		public const string CONFIRMATION_MSG_DEFRAG1 = "CONFIRMATION_MSG_DEFRAG1";
		public const string CONFIRMATION_MSG_DEFRAG2 = "CONFIRMATION_MSG_DEFRAG2";

		public const string PRODUCT_CAPTION = "PRODUCT_CAPTION";
		internal const string ERROR_MSG_DEFRAGMENT = "ERROR_MSG_DEFRAGMENT";
