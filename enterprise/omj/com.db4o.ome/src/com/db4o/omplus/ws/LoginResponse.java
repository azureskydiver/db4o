...
public class LoginResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    protected java.lang.String localLoginResult;
     ...
     */
    public void setLoginResult(java.lang.String param) {
        if (param != null) {
        ...
        if (localLoginResultTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "LoginResult", namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "LoginResult");
                }
            } else {
                xmlWriter.writeStartElement("LoginResult");
            }

            if (localLoginResult == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "LoginResult cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localLoginResult);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localLoginResultTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://db4o.com/User", "LoginResult"));
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"LoginResponse".equals(type)) {
                            ...
                            return (LoginResponse) com.db4o.omplus.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://db4o.com/User",
                            "LoginResult").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setLoginResult(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
