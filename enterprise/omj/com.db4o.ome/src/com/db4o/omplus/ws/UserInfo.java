...
public class UserInfo implements org.apache.axis2.databinding.ADBBean {
    ...
    /**
     * field for SalesforceID
     */
    protected java.lang.String localSalesforceID;

    /*  This tracker boolean wil be used to detect whether the user called the set method
     *   for this attribute. It will be used to determine whether to include this field
     *   in the serialized XML
     */
    protected boolean localSalesforceIDTracker = false;
    ...
    public java.lang.String getSalesforceID() {
        return localSalesforceID;
    }

    /**
     * Auto generated setter method
     * @param param SalesforceID
     */
    public void setSalesforceID(java.lang.String param) {
        if (param != null) {
            //update the setting tracker
            localSalesforceIDTracker = true;
        } else {
            localSalesforceIDTracker = false;
        }

        this.localSalesforceID = param;
    }
        ...
        if (localSalesforceIDTracker) {
            ...
            if (!namespace.equals("")) {
                ...
                if (prefix == null) {
                    ...
                    xmlWriter.writeStartElement(prefix, "SalesforceID",
                        namespace);
                    xmlWriter.writeNamespace(prefix, namespace);
                    xmlWriter.setPrefix(prefix, namespace);
                } else {
                    xmlWriter.writeStartElement(namespace, "SalesforceID");
                }
            } else {
                xmlWriter.writeStartElement("SalesforceID");
            }

            if (localSalesforceID == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "SalesforceID cannot be null!!");
            } else {
                xmlWriter.writeCharacters(localSalesforceID);
            }
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localSalesforceIDTracker) {
            elementList.add(new javax.xml.namespace.QName(
                    "http://db4o.com/User", "SalesforceID"));
    ...
    public static class Factory {
        ...
        public static UserInfo parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"UserInfo".equals(type)) {
                            ...
                            return (UserInfo) com.db4o.omplus.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://db4o.com/User",
                            "SalesforceID").equals(reader.getName())) {
                    java.lang.String content = reader.getElementText();

                    object.setSalesforceID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
