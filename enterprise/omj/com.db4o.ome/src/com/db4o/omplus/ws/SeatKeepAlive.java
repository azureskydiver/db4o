...
/**
 *  SeatKeepAlive bean class
 */
@SuppressWarnings({"unchecked", "unused"})
public class SeatKeepAlive implements org.apache.axis2.databinding.ADBBean {
    ...
    public org.apache.axiom.om.OMElement getOMElement(
        ...
        org.apache.axiom.om.OMDataSource dataSource = new org.apache.axis2.databinding.ADBDataSource(this,
                ...
                public void serialize(
                    ...
                    SeatKeepAlive.this.serialize(MY_QNAME, factory, xmlWriter);
                }
            };
    ...
    public static class Factory {
         ...
         */
        public static SeatKeepAlive parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            SeatKeepAlive object = new SeatKeepAlive();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"SeatKeepAlive".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (SeatKeepAlive) com.db4o.omplus.ws.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
