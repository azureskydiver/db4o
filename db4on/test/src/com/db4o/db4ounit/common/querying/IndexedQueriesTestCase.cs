namespace com.db4o.db4ounit.common.querying
{
	public class IndexedQueriesTestCase : Db4oUnit.Extensions.AbstractDb4oTestCase
	{
		...
		{
			new com.db4o.db4ounit.common.querying.IndexedQueriesTestCase().RunSolo();
		}
		...
		private void IndexField(com.db4o.config.Configuration config, string fieldName)
		{
			IndexField(config, typeof(com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem)
				, fieldName);
		}
		...
		protected override void Store()
		{
			...
			{
				Db().Set(new com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem
					(strings[i]));
			}
		...
		private void AssertIntsFound(int[] ints, int zeroSize, com.db4o.query.Query q)
		{
			...
			while (res.HasNext())
			{
				com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem ci = 
					(com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem)res
					.Next();
				for (int i = 0; i < ints.Length; i++)
				{
					if (ints[i] == ci._int)
		...
		private void AssertQuery(int count, string @string)
		{
			...
			com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem item = 
				(com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem)res
				.Next();
		...
		protected override com.db4o.query.Query NewQuery()
		{
			...
			q.Constrain(typeof(com.db4o.db4ounit.common.querying.IndexedQueriesTestCase.IndexedQueriesItem)
				);
			return q;
		}
	}
