...
{
	public class STDoubleWUTestCase : com.db4o.db4ounit.common.soda.util.SodaBaseTestCase
	{
		...
		{
			return new object[] { new com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase
				(0), new com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase(0), new 
				com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase(1.01), new com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase
				(99.99), new com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase(909.00
				) };
		}
		...
		public virtual void TestEquals()
		{
			...
			q.Constrain(new com.db4o.db4ounit.common.soda.wrapper.untyped.STDoubleWUTestCase(
				0));
