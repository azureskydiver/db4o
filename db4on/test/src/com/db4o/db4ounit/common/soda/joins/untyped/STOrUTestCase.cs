namespace com.db4o.db4ounit.common.soda.joins.untyped
{
	public class STOrUTestCase : com.db4o.db4ounit.common.soda.util.SodaBaseTestCase
	{
		public object orInt;
		...
		{
			return new object[] { new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase
				(0, "hi"), new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(5, null
				), new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(1000, "joho"), 
				new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(30000, "osoo"), new 
				com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(int.MaxValue - 1, null
				) };
		}
		...
		public virtual void TestSmallerGreater()
		{
			...
			q.Constrain(new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase());
		...
		{
			com.db4o.query.Query q = NewQuery();
			q.Constrain(new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(1000, null
				));
		...
		{
			com.db4o.query.Query q = NewQuery();
			q.Constrain(new com.db4o.db4ounit.common.soda.joins.untyped.STOrUTestCase(null, null
				));
