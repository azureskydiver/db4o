namespace com.db4o.db4ounit.common.btree
{
	public class BTreeNodeTestCase : com.db4o.db4ounit.common.btree.BTreeTestCaseBase
	{
		...
		{
			com.db4o.inside.btree.BTreeNode node = Node(3);
		...
		private com.db4o.inside.btree.BTreeNode Node(int value)
		{
			com.db4o.inside.btree.BTreeRange range = Search(value);
			System.Collections.IEnumerator i = range.Pointers();
			i.MoveNext();
			com.db4o.inside.btree.BTreePointer firstPointer = (com.db4o.inside.btree.BTreePointer
				)i.Current;
			com.db4o.inside.btree.BTreeNode node = firstPointer.Node();
		...
		{
			com.db4o.inside.btree.BTreeNode node = Node(3);
			com.db4o.inside.btree.BTreePointer lastPointer = node.LastPointer(Trans());
