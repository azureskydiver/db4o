	...
	public class AllTests : Db4oUnit.TestSuiteBuilder
	{
		public virtual Db4oUnit.TestSuite Build()
		{
			return new Db4oUnit.ReflectionTestSuiteBuilder(new System.Type[] { typeof(com.db4o.db4ounit.common.foundation.ArrayIterator4TestCase)
				...
				, typeof(com.db4o.db4ounit.common.foundation.IteratorsTestCase), typeof(com.db4o.db4ounit.common.foundation.SortedCollection4TestCase)
				, typeof(com.db4o.db4ounit.common.foundation.Stack4TestCase), typeof(com.db4o.db4ounit.common.foundation.TreeKeyIteratorTestCase)
