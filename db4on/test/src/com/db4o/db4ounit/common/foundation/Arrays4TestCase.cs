	...
	public class Arrays4TestCase : Db4oUnit.TestCase
	{
		public virtual void TestContainsInstanceOf()
		{
            ...
            Db4oUnit.Assert.IsTrue(Db4oUnit.Extensions.Db4oUnitPlatform.ArrayContainsInstanceOf
				(array, typeof(string)));
//			Db4oUnit.Assert.IsTrue(com.db4o.db4ounit.Db4oUnitPlatform.ArrayContainsInstanceOf
//				(array, typeof(int)));
//			Db4oUnit.Assert.IsTrue(com.db4o.db4ounit.Db4oUnitPlatform.ArrayContainsInstanceOf
//				(array, typeof(object)));
//			Db4oUnit.Assert.IsFalse(com.db4o.db4ounit.Db4oUnitPlatform.ArrayContainsInstanceOf
//				(array, typeof(float)));
//			Db4oUnit.Assert.IsFalse(com.db4o.db4ounit.Db4oUnitPlatform.ArrayContainsInstanceOf
