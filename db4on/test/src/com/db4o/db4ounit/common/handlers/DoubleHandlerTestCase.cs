namespace com.db4o.db4ounit.common.handlers
{
	...
	{
		private com.db4o.@internal.TypeHandler4 _handler;

		protected override void Db4oSetupBeforeStore()
		{
			_handler = new com.db4o.@internal.handlers.DoubleHandler(Stream());
		}

		public virtual void TestMarshalling()
		{
			double expected = 1.1;
			com.db4o.@internal.Buffer buffer = new com.db4o.@internal.Buffer(_handler.LinkLength
				());
