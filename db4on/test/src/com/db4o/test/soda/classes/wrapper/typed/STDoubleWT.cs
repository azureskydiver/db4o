...
namespace com.db4o.test.soda.classes.wrapper.typed {
   ...
   public class STDoubleWT : STClass {
      [Transient] public static SodaTest st;
      internal Double i_double;
      
      public STDoubleWT() : base() {
      }
      
      internal STDoubleWT(double a_double) : base() {
...
new STDoubleWT(909.0)         };
      }
      
      public void TestEquals() {
         Query q1 = st.Query();
         q1.Constrain(new STDoubleWT(0));
