namespace com.db4o.inside.mapping
{
	...
	public interface IDMapping
	{
		...
		/// 	</returns>
		/// <exception cref="com.db4o.inside.mapping.MappingNotFoundException">if the given id does not refer to a system handler or the empty reference (0) and if no mapping is found
		/// 	</exception>
