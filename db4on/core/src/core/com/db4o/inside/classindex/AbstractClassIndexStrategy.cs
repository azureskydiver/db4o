namespace com.db4o.inside.classindex
{
	...
	public abstract class AbstractClassIndexStrategy : com.db4o.inside.classindex.ClassIndexStrategy
	{
		...
		public abstract System.Collections.IEnumerator AllSlotIDs(com.db4o.Transaction arg1
			);

		public abstract void DefragIndex(com.db4o.ReaderPair arg1);

		public abstract void DefragReference(com.db4o.YapClass arg1, com.db4o.ReaderPair 
			arg2, int arg3);
