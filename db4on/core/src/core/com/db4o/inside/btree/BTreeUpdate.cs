...
{
	public abstract class BTreeUpdate : com.db4o.inside.btree.BTreePatch
	{
		protected com.db4o.inside.btree.BTreeUpdate _next;

		public BTreeUpdate(com.db4o.Transaction transaction, object obj) : base(transaction
			, obj)
		{
		}
		...
		public virtual com.db4o.inside.btree.BTreeUpdate RemoveFor(com.db4o.Transaction trans
			)
		{
			if (_transaction == trans)
			{
		...
		public virtual void Append(com.db4o.inside.btree.BTreeUpdate patch)
		{
		...
		protected abstract void Committed(com.db4o.inside.btree.BTree btree);

		public override object Commit(com.db4o.Transaction trans, com.db4o.inside.btree.BTree
			 btree)
		{
			com.db4o.inside.btree.BTreeUpdate patch = (com.db4o.inside.btree.BTreeUpdate)ForTransaction
				(trans);
			if (patch is com.db4o.inside.btree.BTreeCancelledRemoval)
			{
		...
		protected virtual object InternalCommit(com.db4o.Transaction trans, com.db4o.inside.btree.BTree
			 btree)
		{
			if (_transaction == trans)
			{
		...
		{
			if (newNext is com.db4o.inside.btree.BTreeUpdate)
			{
				_next = (com.db4o.inside.btree.BTreeUpdate)newNext;
			}
			else
			{
				_next = null;
