namespace com.db4o
{
		...
		, com.db4o.foundation.DeepClone, com.db4o.messaging.MessageSender
	{
		...
		internal com.db4o.foundation.Hashtable4 i_exceptionalClasses = new com.db4o.foundation.Hashtable4
			(16);
		...
		internal com.db4o.foundation.Hashtable4 _readAs = new com.db4o.foundation.Hashtable4
			(16);
		...
		internal com.db4o.foundation.Collection4 i_rename;
		...
		public object deepClone(object param)
		{
			...
			{
				ret.i_exceptionalClasses = (com.db4o.foundation.Hashtable4)i_exceptionalClasses.deepClone
					(ret);
			}
			if (i_rename != null)
			{
				ret.i_rename = (com.db4o.foundation.Collection4)i_rename.deepClone(ret);
			}
			if (_reflector != null)
			{
		...
		internal void rename(com.db4o.Rename a_rename)
		{
			if (i_rename == null)
			{
				i_rename = new com.db4o.foundation.Collection4();
			}
