namespace com.db4o.config
{
	...
	/// 	</see>
	/// and
	/// <see cref="com.db4o.ext.ExtObjectServer.Configure">com.db4o.ext.ExtObjectServer.Configure
	/// 	</see>
	/// .
	/// </remarks>
	public interface Configuration
	{
		...
		/// db4o:<br />
		/// -
		/// <see cref="com.db4o.config.TypeAlias">com.db4o.config.TypeAlias</see>
		/// provides an #equals() resolver to match
		/// names directly.<br />
		/// -
		/// <see cref="com.db4o.config.WildcardAlias">com.db4o.config.WildcardAlias</see>
		...
		/// 	</param>
		void GenerateUUIDs(com.db4o.config.ConfigScope setting);
		...
		/// 	</param>
		void GenerateVersionNumbers(com.db4o.config.ConfigScope setting);
		...
		com.db4o.config.QueryConfiguration Queries();
		...
		com.db4o.config.ClientServerConfiguration ClientServer();
	}
}
