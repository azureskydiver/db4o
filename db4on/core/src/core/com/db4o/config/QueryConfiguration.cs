namespace com.db4o.config
{
	...
	public interface QueryConfiguration
	{
		...
		/// a call is
		/// <see cref="com.db4o.ObjectSet.Size">com.db4o.ObjectSet.Size</see>
		/// .
		/// <br /><br />
		...
		/// <see cref="com.db4o.config.QueryEvaluationMode">com.db4o.config.QueryEvaluationMode
		/// 	</see>
		/// constants from the
		/// <see cref="com.db4o.config.QueryEvaluationMode">com.db4o.config.QueryEvaluationMode
		/// 	</see>
		...
		/// 	</see>
		/// </remarks>
		void EvaluationMode(com.db4o.config.QueryEvaluationMode mode);
	}
}
