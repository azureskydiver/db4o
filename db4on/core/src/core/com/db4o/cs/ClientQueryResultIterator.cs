namespace com.db4o.cs
{
	...
	internal class ClientQueryResultIterator : System.Collections.IEnumerator
	{
		...
		private readonly com.db4o.cs.ClientQueryResult _client;

		private readonly com.db4o.foundation.IntIterator4 _ids;

		public ClientQueryResultIterator(com.db4o.cs.ClientQueryResult client)
		{
			_client = client;
		...
		{
			return (com.db4o.cs.YapClient)_client.Stream();
		}
