...
{
	public abstract class MsgBlob : com.db4o.cs.messages.MsgD, com.db4o.BlobStatus
	{
		public com.db4o.BlobImpl _blob;
		...
		public abstract void ProcessClient(com.db4o.foundation.network.YapSocket sock);
