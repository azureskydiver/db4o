...
{
	/// <exclude></exclude>
	public class InMemoryObjectContainer : com.db4o.@internal.LocalObjectContainer
	{
		private bool _closed = false;

		private readonly com.db4o.ext.MemoryFile _memoryFile;

		private int _length = 0;

		protected InMemoryObjectContainer(com.db4o.config.Configuration config, com.db4o.@internal.ObjectContainerBase
			 parent, com.db4o.ext.MemoryFile memoryFile) : base(config, parent)
		{
		...
		public InMemoryObjectContainer(com.db4o.config.Configuration config, com.db4o.ext.MemoryFile
		...
		public override void ReadBytes(byte[] bytes, int address, int length)
		{
			...
			{
				com.db4o.@internal.Exceptions4.ThrowRuntimeException(13, e);
			}
		}
