namespace com.db4o.@internal.query.processor
{
	...
	/// <exclude></exclude>
	public class QConObject : com.db4o.@internal.query.processor.QCon
	{
		...
		[System.NonSerialized]
		internal com.db4o.@internal.Comparable4 i_comparator;
		...
		public QConObject(com.db4o.@internal.Transaction a_trans, com.db4o.@internal.query.processor.QCon
			 a_parent, com.db4o.@internal.query.processor.QField a_field, object a_object) : 
			base(a_trans)
		{
			i_parent = a_parent;
		...
		private void AssociateYapClass(com.db4o.@internal.Transaction a_trans, object a_object
			)
		{
			if (a_object == null)
			{
				i_object = null;
				i_comparator = com.db4o.@internal.Null.INSTANCE;
				i_yapClass = null;
			}
			else
			{
		...
		private sealed class _AnonymousInnerClass84 : com.db4o.foundation.Visitor4
		{
			...
			{
				this._enclosing.AddConstraint((com.db4o.@internal.query.processor.QCon)obj);
			}
			 ...
			 a_candidates, bool rereadObject)
		{
			if (i_field.IsSimple())
			{
				...
				while (i.MoveNext())
				{
					if (i.Current is com.db4o.@internal.query.processor.QConEvaluation)
					{
						hasEvaluation = true;
						break;
					}
				...
				if (hasEvaluation)
				{
					...
					while (j.MoveNext())
					{
						((com.db4o.@internal.query.processor.QCon)j.Current).EvaluateEvaluationsExec(a_candidates
							, false);
					}
				}
			}
		...
		internal override void EvaluateSelf()
		{
			if (i_yapClass != null)
			{
				if (!(i_yapClass is com.db4o.@internal.PrimitiveFieldHandler))
				{
		...
		internal override void Collect(com.db4o.@internal.query.processor.QCandidates a_candidates
			)
		{
			if (i_field.IsClass())
			{
		...
		internal override void EvaluateSimpleExec(com.db4o.@internal.query.processor.QCandidates
			 a_candidates)
		{
		...
		internal virtual com.db4o.@internal.Comparable4 GetComparator(com.db4o.@internal.query.processor.QCandidate
			 a_candidate)
		{
		...
		internal override com.db4o.@internal.ClassMetadata GetYapClass()
		{
			return i_yapClass;
		}

		public override com.db4o.@internal.query.processor.QField GetField()
		{
			return i_field;
		}
		...
		public override bool OnSameFieldAs(com.db4o.@internal.query.processor.QCon other)
		{
			if (!(other is com.db4o.@internal.query.processor.QConObject))
			{
				return false;
			}
			return i_field == ((com.db4o.@internal.query.processor.QConObject)other).i_field;
		}

		internal virtual void PrepareComparison(com.db4o.@internal.query.processor.QField
			 a_field)
		{
		...
		public override void Visit(object obj)
		{
			...
			if (i_selfComparison)
			{
				com.db4o.@internal.ClassMetadata yc = qc.ReadYapClass();
				if (yc != null)
				{
			...
			if (HasOrdering() && res && qc.FieldIsAvailable())
			{
				...
				{
					com.db4o.@internal.Comparable4 comparatorBackup = i_comparator;
					i_comparator = i_field.PrepareComparison(qc.Value());
					i_candidates.AddOrder(new com.db4o.@internal.query.processor.QOrder(this, qc));
		...
		public override com.db4o.query.Constraint Contains()
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEContains(true
					));
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint Equal()
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEEqual());
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint Greater()
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEGreater());
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint Identity()
		{
			lock (StreamLock())
			{
				...
				{
					i_objectID = 0;
					com.db4o.@internal.Exceptions4.ThrowRuntimeException(51);
				}
				RemoveChildrenJoins();
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEIdentity()
					);
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint Like()
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEContains(false
					));
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint Smaller()
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QESmaller());
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint StartsWith(bool caseSensitive)
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEStartsWith
					(caseSensitive));
				return this;
			}
		}
		...
		public override com.db4o.query.Constraint EndsWith(bool caseSensitive)
		{
			lock (StreamLock())
			{
				i_evaluator = i_evaluator.Add(new com.db4o.@internal.query.processor.QEEndsWith(caseSensitive
					));
				return this;
			}
		}
