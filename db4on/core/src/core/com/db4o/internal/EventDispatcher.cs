namespace com.db4o.@internal
{
	...
	public sealed class EventDispatcher
	{
		...
		internal bool Dispatch(com.db4o.@internal.ObjectContainerBase stream, object obj, 
			int eventID)
		{
		...
		internal static com.db4o.@internal.EventDispatcher ForClass(com.db4o.@internal.ObjectContainerBase
			 a_stream, com.db4o.reflect.ReflectClass classReflector)
		{
			if (a_stream == null || classReflector == null)
			{
				return null;
			}
			com.db4o.@internal.EventDispatcher dispatcher = null;
			int count = 0;
