namespace com.db4o.@internal.freespace
{
	...
	{
		internal com.db4o.@internal.ix.Index4 _index;

		internal com.db4o.@internal.ix.IndexTransaction _indexTrans;

		internal com.db4o.@internal.ix.IxTraverser _traverser;

		internal com.db4o.@internal.freespace.FreespaceVisitor _visitor;

		internal FreespaceIx(com.db4o.@internal.LocalObjectContainer file, com.db4o.MetaIndex
			 metaIndex)
		{
			_index = new com.db4o.@internal.ix.Index4(file.GetSystemTransaction(), new com.db4o.@internal.handlers.IntHandler
		...
		{
			_traverser = new com.db4o.@internal.ix.IxTraverser();
			_traverser.FindBoundsExactMatch(val, (com.db4o.@internal.ix.IxTree)_indexTrans.GetRoot
				());
		}
		...
		{
			_visitor = new com.db4o.@internal.freespace.FreespaceVisitor();
