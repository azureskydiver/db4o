namespace com.db4o.@internal
{
	...
	public sealed class Messages
	{
			...
			msg, System.Exception t)
		{
			...
			System.IO.TextWriter ps = ((com.db4o.@internal.Config4Impl)config).ErrStream();
			new com.db4o.@internal.Message(msg, code, ps);
			if (t != null)
			{
				new com.db4o.@internal.Message(null, 25, ps);
				j4o.lang.JavaSystem.PrintStackTrace(t, ps);
				new com.db4o.@internal.Message(null, 26, ps, false);
			}
		}
		...
		public static void LogMsg(com.db4o.config.Configuration config, int code, string 
			msg)
		{
			com.db4o.@internal.Config4Impl c4i = (com.db4o.@internal.Config4Impl)config;
			if (c4i == null)
			{
				c4i = (com.db4o.@internal.Config4Impl)com.db4o.Db4o.Configure();
			}
			if (c4i.MessageLevel() > com.db4o.@internal.Const4.NONE)
			{
				new com.db4o.@internal.Message(msg, code, c4i.OutStream());
			}
		}
	}
}
