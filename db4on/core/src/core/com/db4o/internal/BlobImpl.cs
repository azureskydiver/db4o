namespace com.db4o.@internal
{
	...
	/// <exclude></exclude>
	public class BlobImpl : com.db4o.types.Blob, j4o.lang.Cloneable, com.db4o.@internal.Db4oTypeImpl
	{
		...
		{
			com.db4o.@internal.BlobImpl bi = null;
			try
			{
				bi = (com.db4o.@internal.BlobImpl)this.MemberwiseClone();
				bi.SetTrans(a_trans);
			}
		...
		public virtual void ReadFrom(j4o.io.File file)
		{
			if (!file.Exists())
			{
				throw new System.IO.IOException(com.db4o.@internal.Messages.Get(41, file.GetAbsolutePath
					()));
			}
		...
		public virtual j4o.io.File ServerFile(string promptName, bool writeToServer)
		{
				...
				if (fileName == null)
				{
					...
					while (new j4o.io.File(path, tryPath).Exists())
					{
						...
						if (i == 99)
						{
							...
							throw new System.IO.IOException(com.db4o.@internal.Messages.Get(40));
						}
					}
					fileName = tryPath;
					lock (i_stream.i_lock)
			...
			else
			{
				if (fileName == null)
				{
					throw new System.IO.IOException(com.db4o.@internal.Messages.Get(38));
				}
			}
			...
			if (!writeToServer)
			{
				...
				{
					throw new System.IO.IOException(com.db4o.@internal.Messages.Get(39));
				}
			}
		...
		public virtual void WriteTo(j4o.io.File file)
		{
			...
			{
				throw new System.IO.IOException(com.db4o.@internal.Messages.Get(43));
			}
			if (i_stream.IsClient())
			{
				i_file = file;
