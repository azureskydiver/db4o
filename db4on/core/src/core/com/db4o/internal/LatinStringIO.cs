namespace com.db4o.@internal
{
	...
	public class LatinStringIO
	{
		...
		{
			return com.db4o.@internal.Const4.ISO8859;
		}

		internal static com.db4o.@internal.LatinStringIO ForEncoding(byte encodingByte)
		{
			switch (encodingByte)
			{
				case com.db4o.@internal.Const4.ISO8859:
				{
					return new com.db4o.@internal.LatinStringIO();
				}

				default:
				{
					return new com.db4o.@internal.UnicodeStringIO();
					break;
				}
			}
		}
		...
		{
			return a_string.Length + com.db4o.@internal.Const4.OBJECT_LENGTH + com.db4o.@internal.Const4
				.INT_LENGTH;
		}
		...
		public virtual string Read(com.db4o.@internal.Buffer bytes, int a_length)
		{
		...
		{
			return a_string.Length + com.db4o.@internal.Const4.INT_LENGTH;
		}
		...
		public virtual void Write(com.db4o.@internal.Buffer bytes, string @string)
		{
