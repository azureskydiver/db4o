...
{
	/// <exclude></exclude>
	public abstract class NetTypeHandler : com.db4o.@internal.handlers.PrimitiveHandler
		, com.db4o.@internal.handlers.NetType
	{
		public NetTypeHandler(com.db4o.@internal.ObjectContainerBase stream) : base(stream
			)
		{
		}
