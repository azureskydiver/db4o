namespace com.db4o.io
{
	...
	/// </remarks>
	public class CachedIoAdapter : com.db4o.io.IoAdapter
	{
		...
		public CachedIoAdapter(com.db4o.io.IoAdapter ioAdapter) : this(ioAdapter, DEFAULT_PAGE_SIZE
			, DEFAULT_PAGE_COUNT)
		{
		}

		public CachedIoAdapter(com.db4o.io.IoAdapter ioAdapter, int pageSize, int pageCount
			)
		{
			_io = ioAdapter;
			_pageSize = pageSize;
		...
		public CachedIoAdapter(string path, bool lockFile, long initialLength, com.db4o.io.IoAdapter
		...
		{
			return new com.db4o.io.CachedIoAdapter(path, lockFile, initialLength, _io, _pageSize
				, _pageCount);
		}
		...
		{
			_head = new com.db4o.io.CachedIoAdapter.Page(_pageSize);
			_head.prev = null;
			com.db4o.io.CachedIoAdapter.Page page = _head;
			com.db4o.io.CachedIoAdapter.Page next = _head;
			for (int i = 0; i < _pageCount - 1; ++i)
			{
				next = new com.db4o.io.CachedIoAdapter.Page(_pageSize);
				page.next = next;
				next.prev = page;
				page = next;
			}
		...
		public override int Read(byte[] buffer, int length)
		{
			...
			com.db4o.io.CachedIoAdapter.Page page;
			int readLength;
			int bufferOffset = 0;
		...
		public override void Write(byte[] buffer, int length)
		{
			long startAddress = _position;
			long endAddress = startAddress + length;
			com.db4o.io.CachedIoAdapter.Page page = null;
			int writtenLength;
			int bufferOffset = 0;
			while (startAddress < endAddress)
			{
		...
		private com.db4o.io.CachedIoAdapter.Page GetPage(long startAddress, bool load)
		{
			com.db4o.io.CachedIoAdapter.Page page;
		...
		private com.db4o.io.CachedIoAdapter.Page GetFreePage()
		{
			if (!_tail.IsFree())
			{
				FlushPage(_tail);
		...
		private com.db4o.io.CachedIoAdapter.Page GetPageFromCache(long pos)
		{
			com.db4o.io.CachedIoAdapter.Page page = _head;
			while (page != null)
			{
		...
		{
			com.db4o.io.CachedIoAdapter.Page node = _head;
			while (node != null)
			{
				FlushPage(node);
				node = node.next;
		...
		private void FlushPage(com.db4o.io.CachedIoAdapter.Page page)
		{
			if (!page.dirty)
			{
				return;
		...
		private void LoadPage(com.db4o.io.CachedIoAdapter.Page page, long pos)
		{
		...
		private void MovePageToHead(com.db4o.io.CachedIoAdapter.Page page)
		{
			if (page == _head)
			{
				return;
			...
			if (page == _tail)
			{
				com.db4o.io.CachedIoAdapter.Page tempTail = _tail.prev;
				tempTail.next = null;
				_tail.next = _head;
				_tail.prev = null;
				_head.prev = page;
		...
		private void WritePage(com.db4o.io.CachedIoAdapter.Page page)
		{
		...
		private class Page
		{
			...
			internal com.db4o.io.CachedIoAdapter.Page prev;

			internal com.db4o.io.CachedIoAdapter.Page next;
