namespace Db4oUnit.Extensions
{
	...
	{
		private sealed class Db4oLabelProvider : Db4oUnit.TestMethod.LabelProvider
		{
			public static readonly Db4oUnit.TestMethod.LabelProvider DEFAULT = new Db4oUnit.Extensions.Db4oTestSuiteBuilder.Db4oLabelProvider
				();
		...
		public Db4oTestSuiteBuilder(Db4oUnit.Extensions.Db4oFixture fixture, System.Type 
			clazz) : base(clazz)
		{
			SetFixture(fixture);
		}
		...
		private void SetFixture(Db4oUnit.Extensions.Db4oFixture fixture)
		{
			if (null == fixture)
			{
		...
		protected override Db4oUnit.Test CreateTest(object instance, System.Reflection.MethodInfo
			 method)
		{
			if (instance is Db4oUnit.Extensions.AbstractDb4oTestCase)
			{
