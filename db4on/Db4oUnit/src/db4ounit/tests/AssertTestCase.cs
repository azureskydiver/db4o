...
{
	public class AssertTestCase : Db4oUnit.TestCase
	{
		...
		private sealed class _AnonymousInnerClass14 : Db4oUnit.CodeBlock
		{
		...
		private sealed class _AnonymousInnerClass19 : Db4oUnit.CodeBlock
		{
		...
		private sealed class _AnonymousInnerClass24 : Db4oUnit.CodeBlock
		{
		...
		private void ExpectFailure(Db4oUnit.CodeBlock block)
		{
