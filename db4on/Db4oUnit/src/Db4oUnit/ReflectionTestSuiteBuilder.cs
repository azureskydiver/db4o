	...
	public class ReflectionTestSuiteBuilder : Db4oUnit.TestSuiteBuilder
	{
		...
		protected virtual Db4oUnit.TestSuite FromClass(System.Type clazz)
		{
			if (!IsApplicable(clazz))
			{
				...
				return new Db4oUnit.TestSuite(new Db4oUnit.Test[0]);
			}
		...
		private static Db4oUnit.Test[] ToTestArray(System.Collections.ArrayList tests)
		{
		...
		protected virtual Db4oUnit.Test CreateTest(object instance, System.Reflection.MethodInfo
			 method)
		{
