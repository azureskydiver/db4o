namespace Db4oUnit
{
	...
	public class TestMethod : Db4oUnit.Test
	{
		...
		private sealed class _AnonymousInnerClass15 : Db4oUnit.TestMethod.LabelProvider
		{
		...
		public static Db4oUnit.TestMethod.LabelProvider DEFAULT_LABEL_PROVIDER = new _AnonymousInnerClass15
			();
		...
		private readonly Db4oUnit.TestMethod.LabelProvider _labelProvider;
		...
		public TestMethod(object instance, System.Reflection.MethodInfo method, Db4oUnit.TestMethod.LabelProvider
			 labelProvider)
		{
			if (null == instance)
			{
		...
		{
			if (_subject is Db4oUnit.TestLifeCycle)
			{
				try
				{
					((Db4oUnit.TestLifeCycle)_subject).TearDown();
				}
				catch (System.Exception e)
				{
		...
		protected virtual void SetUp()
		{
			if (_subject is Db4oUnit.TestLifeCycle)
			{
				try
				{
					((Db4oUnit.TestLifeCycle)_subject).SetUp();
				}
				catch (System.Exception e)
				{
