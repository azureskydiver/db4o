...
namespace Db4objects.Db4odoc.ClientServer
{
	public class ClientServerExample
	{
		...
		public static void Main(string[] args)
		{
			...
			IObjectServer server = Db4oFactory.OpenServer(ConfigureDb4o(), Db4oFileName, 0);
			try
			{
        ...
        private static IConfiguration ConfigureDb4o()
		{
		...
		{
			IObjectServer server = Db4oFactory.OpenServer(Db4oFileName, ServerPort);
			server.GrantAccess(ServerUser, ServerPassword);
			try
			{
        ...
        private static void ListRefreshedResult(IObjectContainer container, IObjectSet items, int depth)
		{
