namespace Db4objects.Drs.Inside
{
	public sealed class GenericReplicationSession : Db4objects.Drs.IReplicationSession
	{
			...
			)
		{
			...
			sourceProvider.VisitCachedReferences(new _AnonymousInnerClass193(this, sourceProvider
				));
		}

		private sealed class _AnonymousInnerClass193 : Db4objects.Db4o.Foundation.IVisitor4
		{
			public _AnonymousInnerClass193(GenericReplicationSession _enclosing, Db4objects.Drs.Inside.IReplicationProviderInside
				 sourceProvider)
			{
		...
		private object CollectionClone(object original, Db4objects.Db4o.Reflect.IReflectClass
			 claxx, Db4objects.Drs.Inside.IReplicationProviderInside sourceProvider)
		{
			return _collectionHandler.CloneWithCounterparts(original, claxx, new _AnonymousInnerClass237
				(this, sourceProvider));
		}

		private sealed class _AnonymousInnerClass237 : Db4objects.Drs.Inside.ICounterpartFinder
		{
			public _AnonymousInnerClass237(GenericReplicationSession _enclosing, Db4objects.Drs.Inside.IReplicationProviderInside
				 sourceProvider)
			{
				this._enclosing = _enclosing;
				this.sourceProvider = sourceProvider;
			 ...
			 destination)
		{
			...
			destination.VisitCachedReferences(new _AnonymousInnerClass279(this, destination));
			source.VisitCachedReferences(new _AnonymousInnerClass285(this, destination));
		}

		private sealed class _AnonymousInnerClass279 : Db4objects.Db4o.Foundation.IVisitor4
		{
			public _AnonymousInnerClass279(GenericReplicationSession _enclosing, Db4objects.Drs.Inside.IReplicationProviderInside
				 destination)
			{
				this._enclosing = _enclosing;
		...
		private sealed class _AnonymousInnerClass285 : Db4objects.Db4o.Foundation.IVisitor4
		{
			public _AnonymousInnerClass285(GenericReplicationSession _enclosing, Db4objects.Drs.Inside.IReplicationProviderInside
				 destination)
			{
				this._enclosing = _enclosing;
				this.destination = destination;
