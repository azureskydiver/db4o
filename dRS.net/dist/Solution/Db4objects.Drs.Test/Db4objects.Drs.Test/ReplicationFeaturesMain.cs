namespace Db4objects.Drs.Test
{
	public class ReplicationFeaturesMain : Db4objects.Drs.Test.DrsTestCase
	{
		...
		private readonly Db4objects.Drs.Test.Set4 _setA = new Db4objects.Drs.Test.Set4(1);

		private readonly Db4objects.Drs.Test.Set4 _setB = new Db4objects.Drs.Test.Set4(1);

		private readonly Db4objects.Drs.Test.Set4 _setBoth = new Db4objects.Drs.Test.Set4
			(2);

		private readonly Db4objects.Drs.Test.Set4 _NONE = Db4objects.Drs.Test.Set4.EMPTY_SET;

		private Db4objects.Drs.Test.Set4 _direction;

		private Db4objects.Drs.Test.Set4 _containersToQueryFrom;

		private Db4objects.Drs.Test.Set4 _containersWithNewObjects;

		private Db4objects.Drs.Test.Set4 _containersWithChangedObjects;

		private Db4objects.Drs.Test.Set4 _containersWithDeletedObjects;

		private Db4objects.Drs.Test.Set4 _containerStateToPrevail;
		...
		{
			System.Collections.IEnumerator i = _containersWithDeletedObjects.Iterator();
			i.MoveNext();
		...
		private sealed class _AnonymousInnerClass176 : Db4objects.Drs.IReplicationEventListener
		{
		...
		private string Print(Db4objects.Drs.Test.Set4 containerSet)
		{
		...
		private string First(Db4objects.Drs.Test.Set4 containerSet)
		{
			System.Collections.IEnumerator i = containerSet.Iterator();
			i.MoveNext();
			return (string)i.Current;
		}
		...
		private void TstDirection(Db4objects.Drs.Test.Set4 direction)
		{
		...
		private void TstQueryingFrom(Db4objects.Drs.Test.Set4 containersToQueryFrom)
		{
		...
		private void TstWithChangedObjectsIn(Db4objects.Drs.Test.Set4 containers)
		{
		...
		private void TstWithDeletedObjectsIn(Db4objects.Drs.Test.Set4 containers)
		{
		...
		private void TstWithNewObjectsIn(Db4objects.Drs.Test.Set4 containersWithNewObjects
			)
		{
		...
		private void TstWithContainerStateToPrevail(Db4objects.Drs.Test.Set4 containers)
		{
	...
	internal class Set4
	{
		public static readonly Db4objects.Drs.Test.Set4 EMPTY_SET = new Db4objects.Drs.Test.Set4
			(0);

		internal Db4objects.Db4o.Foundation.Hashtable4 _table;
		...
		public virtual void AddAll(Db4objects.Drs.Test.Set4 other)
		{
		...
		public virtual bool ContainsAll(Db4objects.Drs.Test.Set4 other)
		{
		...
		{
			Db4objects.Db4o.Foundation.Collection4 elements = new Db4objects.Db4o.Foundation.Collection4
				();
			_table.ForEachKey(new _AnonymousInnerClass593(this, elements));
			return elements.GetEnumerator();
		}

		private sealed class _AnonymousInnerClass593 : Db4objects.Db4o.Foundation.IVisitor4
		{
			public _AnonymousInnerClass593(Set4 _enclosing, Db4objects.Db4o.Foundation.Collection4
				 elements)
			{
				this._enclosing = _enclosing;
			...
			private readonly Db4objects.Db4o.Foundation.Collection4 elements;
		}
