...
public class SimpleArrayTestHsqlRefAsTableDiffDb extends SimpleArrayTest {

	protected TestableReplicationProviderInside prepareProviderA() {
		Configuration configuration = HibernateConfigurationFactory.createNewDbConfig();
		configuration.addClass(SimpleArrayHolder.class);
		configuration.addClass(SimpleArrayContent.class);
		return new RefAsTableReplicationProvider(configuration, HibernateConfigurationFactory.createNewDbConfig(), "A");
	}
	...
	protected TestableReplicationProviderInside prepareProviderB() {
		...
		configuration.addClass(SimpleArrayHolder.class);
		configuration.addClass(SimpleArrayContent.class);
		return new RefAsTableReplicationProvider(configuration, HibernateConfigurationFactory.createNewDbConfig(), "B");
	}
