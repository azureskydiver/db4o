...
public abstract class SimpleParentChild extends ReplicationTestcase{
    ...
    private void ensureNames(TestableReplicationProvider provider, String parentName, String childName){
    ...
    private void ensureOneInstanceOfParentAndChild(TestableReplicationProvider provider){
