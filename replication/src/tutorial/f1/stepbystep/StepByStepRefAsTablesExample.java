...
public class StepByStepRefAsTablesExample {
	protected String db4oFileName = "StepByStepRefAsTablesExample.yap";
	protected final String hibernateConfigurationFileName = "f1/stepbystep/hibernate.cfg.xml";

	public static void main(String[] args) {
		new StepByStepRefAsTablesExample().run();
	}

	public void run() {
		new File(db4oFileName).delete();

		System.out.println("Running StepByStepRefAsTables Example. This example use a no dRS columns options");
	...
	private void replicateAllToHibernate() {
		...
		ReplicationSession replication = Replication.begin(db4o, hibernate, true);
