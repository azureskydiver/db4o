...
namespace Db4objects.Db4odoc.ListDeleting
{
    ...
    {
        public const string DbFile = "Test.db";
        ...
        private static void RemoveTest(){
            ...
            try
            {
            	...
            	// modify List field
            	db.Ext().Configure().ObjectClass(typeof(ListObject)).UpdateDepth(1);
        ...
        private static void DeleteTest(){
            ...
            try
            {
                ...
                db.Ext().Configure().ObjectClass(typeof(ListObject)).CascadeOnDelete(true);
                IList<ListObject> result = db.Query<ListObject>(typeof(ListObject));
                if (result.Count > 0)
                {
                	// retrieve a ListObject
