...
public class RegistryEnhancer {
	...
	private void generateCLASSINFOField() {
		FieldEditor fe = context.createField(ce, 26, Type.getType(Hashtable.class),
				"CLASSINFO");
		...
		// access flags 8
		// static <clinit>() : void
		MethodBuilder bld=new MethodBuilder(context,ce, Modifiers.STATIC, void.class,
				"<clinit>", new Class[0], new Class[0]);
		bld.newRef(Hashtable.class);
		bld.dup();
		bld.ldc(2);
		bld.invoke(Opcode.opc_invokespecial, Hashtable.class,
...
//		me.addInstruction(Opcode.opc_return);
	...
	private void classForName(MethodBuilder builder,Class clazz) {
		...
		builder.invoke(Opcode.opc_invokestatic,builder.parentType(), "db4o$class$", new Class[]{String.class}, Class.class);
	}
	...
	private void generateInfoForMethod() {
		...
		bld.aload(1);
		bld.invoke(Opcode.opc_invokevirtual, Hashtable.class,"get", new Class[] { Object.class }, Object.class);
	...
	private void generateArrayForMethod() {
		MethodBuilder bld=new MethodBuilder(context,ce, Modifiers.PUBLIC, Object.class,
				"arrayFor", new Class[] { Class.class, Integer.class },null);
		int labelIdx=1;
	...
	private void generateComponentTypeMethod() {
		MethodBuilder bld=new MethodBuilder(context,ce, Modifiers.PUBLIC, Class.class,
		...
		bld.aload(0);
		bld.aload(1);
		bld.invoke(Opcode.opc_invokespecial, com.db4o.reflect.self.SelfReflectionRegistry.class,
