...
namespace com.db4o.ext {
   ...
   public interface ObjectCallbacks {
      ...
      bool objectCanActivate(ObjectContainer objectcontainer);
      
      bool objectCanDeactivate(ObjectContainer objectcontainer);
      
      bool objectCanDelete(ObjectContainer objectcontainer);
      
      bool objectCanNew(ObjectContainer objectcontainer);
      
      bool objectCanUpdate(ObjectContainer objectcontainer);
