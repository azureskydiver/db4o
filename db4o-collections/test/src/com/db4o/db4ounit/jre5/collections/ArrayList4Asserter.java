...
public class ArrayList4Asserter {
	...
	public static void assertClear_Iterator(final ArrayList4<Integer> list) throws Exception {
		final Iterator<Integer> iterator = list.iterator();
		list.clear();
		Assert.expect(ConcurrentModificationException.class, new CodeBlock(){
			public void run() throws Throwable {
	...
	public static void assertClone(final ArrayList4<Integer> list) throws Exception {
		list.add(null);
	...
	public static void assertEquals(final ArrayList4<Integer> list) throws Exception {
