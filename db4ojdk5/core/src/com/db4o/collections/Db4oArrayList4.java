 ...
 * @exclude
 */
public class Db4oArrayList4<E> extends ArrayList<E> {
	...
	private class Db4oArrayListIterator implements Iterator<E> {
		...
		public void remove() {
			checkCanOperate();
			checkConcurrentModification();
			Db4oArrayList4.this.remove(currentIndex);
			--currentIndex;
			syncModCount();
	...
	private class Db4oArrayListIndexIterator extends Db4oArrayListIterator
		...
		public void add(E element) {
			...
			checkConcurrentModification();
			try {
				Db4oArrayList4.this.add(currentIndex, element);
				++currentIndex;
				syncModCount();
				setCanOperateFlag(false);
			} catch (IndexOutOfBoundsException e) {
		...
		public void set(E element) {
			...
			checkConcurrentModification();
			try {
				Db4oArrayList4.this.set(currentIndex, element);
				setCanOperateFlag(false);
			} catch (IndexOutOfBoundsException e) {
				throw new ConcurrentModificationException();
			}
