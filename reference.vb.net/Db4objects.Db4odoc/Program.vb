Module Program
    ...
    Sub Main(ByVal args As String())
        ...
        'Dim f As System.IO.FileInfo = New System.IO.FileInfo("Console.txt")
        'Dim Tex As System.IO.StreamWriter = f.CreateText()
        ''System.Console.SetOut(Tex)
        'Db4objects.Db4odoc.ClientServer.DeepExample.Main(args)
        'Db4objects.Db4odoc.Transactions.TransactionExample.Main(args)
