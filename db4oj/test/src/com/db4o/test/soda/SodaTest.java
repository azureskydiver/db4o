...
import com.db4o.test.soda.arrays.typed.*;
import com.db4o.test.soda.arrays.untyped.*;
...
import com.db4o.test.soda.wrapper.typed.*;
    ...
    public static final STClass[] CLASSES =
        ...
        public void run(STClass[] classes, STEngine[] engines, boolean a_quiet) {
            ...
            if (failedTestClasses.size() > 0) {
                System.err.println("\nFailed test classes:\n");
                Iterator4 i = failedTestClasses.fastIterator();
                while (i.hasNext()) {
