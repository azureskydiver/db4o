...
public class VodCobraTestCase extends VodDatabaseTestCaseBase implements TestLifeCycle {
	...
	public void testStore(){
		...
		ObjectLifecycleEvent objectLifecycleEvent = new ObjectLifecycleEvent(1, expectedObjectLoid, 3, 4, "invalid");
	...
	public void testQueryForExtent() {
		ObjectLifecycleEvent original = new ObjectLifecycleEvent(1, 2, 3, 4, "invalid");
	...
	public void testCobraQLin(){
		...
		_cobra.store(new ObjectLifecycleEvent(1, objectLoid, 3, 4, "invalid"));
