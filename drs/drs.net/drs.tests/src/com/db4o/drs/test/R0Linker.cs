namespace com.db4o.drs.test
{
	internal class R0Linker
	{
		...
		internal R0Linker()
		{
			r0 = new com.db4o.drs.test.R0();
			r1 = new com.db4o.drs.test.R1();
			r2 = new com.db4o.drs.test.R2();
			r3 = new com.db4o.drs.test.R3();
			r4 = new com.db4o.drs.test.R4();
		}
		...
		public virtual void Store(com.db4o.drs.inside.TestableReplicationProviderInside provider
			)
		{
