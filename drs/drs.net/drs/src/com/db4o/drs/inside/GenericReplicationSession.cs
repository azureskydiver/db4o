namespace com.db4o.drs.inside
{
	public sealed class GenericReplicationSession : com.db4o.drs.ReplicationSession
	{
			 ...
			 sourceProvider)
		{
			...
			com.db4o.drs.inside.ReplicationReference @ref = sourceProvider.ProduceReference(value
				, null, null);
			if (@ref == null)
			{
			 ...
			 sourceProvider)
		{
			for (int i = 0; i < objects.Length; i++)
			{
				...
				{
					throw new j4o.lang.RuntimeException(sourceProvider + " cannot find ref for " + @object
						);
				}
