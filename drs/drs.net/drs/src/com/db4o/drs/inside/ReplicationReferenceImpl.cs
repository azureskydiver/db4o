...
{
	public sealed class ReplicationReferenceImpl : com.db4o.drs.inside.ReplicationReference
	{
		private bool _objectIsNew;

		private readonly object _obj;

		private readonly com.db4o.ext.Db4oUUID _uuid;
		...
		public ReplicationReferenceImpl(object obj, com.db4o.ext.Db4oUUID uuid, long version
			)
		{
			this._obj = obj;
			this._uuid = uuid;
		...
		public sealed override bool Equals(object o)
		{
			...
			com.db4o.drs.inside.ReplicationReference that = (com.db4o.drs.inside.ReplicationReferenceImpl
				)o;
		...
		public com.db4o.ext.Db4oUUID Uuid()
		{
			return _uuid;
		}
