namespace com.db4o.drs
{
	...
	public interface ReplicationSession
	{
		...
		com.db4o.drs.ReplicationProvider ProviderA();
		...
		com.db4o.drs.ReplicationProvider ProviderB();
		...
		/// <see cref="com.db4o.drs.ReplicationSession.Replicate">com.db4o.drs.ReplicationSession.Replicate
		/// 	</see>
		/// .
		/// </remarks>
		...
		/// 	</param>
		void SetDirection(com.db4o.drs.ReplicationProvider from, com.db4o.drs.ReplicationProvider
			 to);
	}
}
