namespace Db4objects.Drs.Test
{
    public class ListTest : Db4objects.Drs.Test.DrsTestCase
    {
        ...
        {
            Db4objects.Drs.Test.ListHolder lh = (Db4objects.Drs.Test.ListHolder)GetOneInstance(B().Provider(), typeof(Db4objects.Drs.Test.ListHolder));
            lh.SetName("h2");
            Db4objects.Drs.Test.ListContent lc1 = (Db4objects.Drs.Test.ListContent)lh.GetList()[0];//.Get(0);
            Db4objects.Drs.Test.ListContent lc2 = (Db4objects.Drs.Test.ListContent)lh.GetList()[1];//.Get(1);
            lc1.SetName("co1");
            lc2.SetName("co2");
        ...
        {
            Db4objects.Drs.Test.ListHolder lh = (Db4objects.Drs.Test.ListHolder)GetOneInstance(A(
                ).Provider(), typeof(Db4objects.Drs.Test.ListHolder));
            lh.SetName("h3");
            ...
            provider, string[] holderNames, string[] contentNames)
        {
            ...
            {
                Db4objects.Drs.Test.ListHolder lh = (Db4objects.Drs.Test.ListHolder)objectSet.Next();
                ...
                {
                    Db4objects.Drs.Test.ListContent lc = (Db4objects.Drs.Test.ListContent)list[j];//.Get(j);
