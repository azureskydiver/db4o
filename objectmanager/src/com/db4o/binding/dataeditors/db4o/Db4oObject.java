...
public class Db4oObject implements IObjectEditor {
    ...
    public IFieldController bind(Control control, String propertyName) {
        ...
        if (DuckType.instanceOf(ICheckboxButtonField.class, control)) {
            result = new CheckboxButtonFieldController(control, this, propertyEditor);
        } else if (DuckType.instanceOf(ICheckboxListField.class, control)) {
            result = new CheckboxListFieldController(control, this, propertyEditor);
        } else if (DuckType.instanceOf(IComboField.class, control)) {
            result = new ComboFieldController(control, this, propertyEditor);
        } else {
            result = new TextFieldController(control, this, propertyEditor);
        }
