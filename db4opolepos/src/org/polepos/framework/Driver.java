...
public abstract class Driver
{
     ...
     * Called for every Circuit for every TurnSetup.
     * Expected proceding: Start with a new and clean database.
	 */
	...
	/**
	 * Called just before each lap method is called.
	...
	/**
     * Called after each lap so that the driver can
     * clean up any files it created and close any 
     * resources it opened.
     * Normally closes the database.
     */
